...
class Spin12:
    ...
    def __init__(self, sym='dense', **kwargs):
        ...
        Notes
        -----
            Assume the following basis conventions:
            For dense: (sz=+1/2, sz=-1/2)
            For Z2: t=0 <-> sz=+1/2, t=1 <-> sz=-1/2
            For U1: t=-1 <-> sz=+1/2, t=1 <-> sz=-1/2
            This way all have the same standard matrix representation after :meth:`yast.to_numpy`,
            where charges are arraged in the increasing order.
        """
