...
class EnvNTU:
    ...
    def bond_metric(self, Q0, Q1, s0, s1, dirn):
         """
         Calculate bond metric, with the size of environment controlled by :code:`which`.

         Below, double lines indicate core bonds that are contracted exactly.
         Single lines indicate tree-like approximations of border tensors resulting from their rank-one SVD decomposition.
