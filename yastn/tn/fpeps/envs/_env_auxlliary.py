...
def append_vec_tl(Ac, A, vectl):  # A = [t l] [b r] s;  Ac = [t' l'] [b' r'] s;  vectl = x [l l'] [t t'] y
...
def append_vec_br(Ac, A, vecbr):  # A = [t l] [b r] s;  Ac = [t' l'] [b' r'] s;  vecbr = x [r r'] [b b'] y
...
def append_vec_tr(Ac, A, vectr):  # A = [t l] [b r] s;  Ac = [t' l'] [b' r'] s;  vectr = x [t t'] [r r'] y
    """ Append the A and Ac tensors to the top-left vector """
...
def append_vec_bl(Ac, A, vecbl):  # A = [t l] [b r] s;  Ac = [t' l'] [b' r'] s;  vecbl = x [b b'] [l l'] y
    """ Append the A and Ac tensors to the top-left vector """
