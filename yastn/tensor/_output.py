...
def separate_data_and_meta(d: dict) -> tuple[tuple[array], dict]:
    """
    Parse nested dictionaries generated by to_dict methods to extract and enumerate data arrays.
    Assume that data arrays are stored under key "_data".
    Data arrays are combined into a tuple, and arrays in the dictionary are replace with positions in the tuple.

    Return:
    data, meta
    data is a tuple; and meta is dictionary
    """
    pass


def combine_data_and_meta(data: tuple, meta: dict) -> tuple[tuple[array], dict]:
    """
    Reverse separate_data_and_meta
    """
    pass
