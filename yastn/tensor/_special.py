...
def _attach_01(M, T):
    """ :code:`M._attach_01(T) == ncon([T, M], ((-0, 1, 2, -2), (2, 1, -1, -3)))`. """
    return ncon([T, M], ((-0, 1, 2, -2), (2, 1, -1, -3)))

def _attach_23(M, T):
    """ :code:`M._attach_23(T) == ncon([T, M], ((-0, 1, 2, -2), (-1, -3, 2, 1)))`. """
    return ncon([T, M], ((-0, 1, 2, -2), (-1, -3, 2, 1)))

def _attach_12(M, T):
    """ :code:`M._attach_12(T) == ncon([T, M], ((-0, 1, 2, -2), (-3, 2, 1, -1)))`. """
    return ncon([T, M], ((-0, 1, 2, -2), (-3, 2, 1, -1)))

def _attach_30(M, T):
    """ :code:`M._attach_30(T) == ncon([T, M], ((-0, 1, 2, -2), (1, -1, -3, 2)))`. """
