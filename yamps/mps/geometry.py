...
class Geometry:
    ...
    def __init__(self, N):
        ...
        ----------
        N : int
            Length of a 1d chain (here this is all the information that is needed)
        """
        self.N = N  # length of mps
        self.first = 0  # index of "first" (leftmost) site
        self.last = N - 1  # index of "last" (rightmost) site
