...
class CtmBenchYastnNoFuse(CtmBenchParent):
    ...
    def __init__(self, args):
        ...
        if self.a.ndim == 6:  # ancilla leg present
    ...
    def print_info(self):
        print("==================== ")
        print("Do not form double-layer tensor; no fusion in building tensors. ")
        print("Config: ")
        print(self.a.config)
    ...
    def enlarged_corner(self):
        self.C2x2_tr = yastn.einsum('aCEA,AB,BDFd,GCbeD,GEcfF->abcdef',
                            self.Tt, self.Ctr, self.Tr, self.a, self.a.conj(),
                            order='ABGCDEF')

    def fuse_enlarged_corner(self):
        self.C2x2_mat = self.C2x2_tr.fuse_legs(axes=((0, 1, 2), (3, 4, 5)))
