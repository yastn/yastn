...
def influence_LinInv(w, W, u):
    ...
    %   frequencies w and returns a same size array of the influence.
    """
    return np.heaviside(u/2+w, .5)*np.heaviside(u/2-w, .5)+(np.heaviside(w-u/2, .5)+np.heaviside(-u/2-w, .5))*(u/2)**2/(w+np.specing(1)*abs(abs(np.sign(w))-1))**2
...
def influence_LinInv1D(w, W, u):
    ...
    %   frequencies w and returns a same size array of the influence.
    """
    return np.sqrt(1-(2*w/W)**2)*(np.heaviside(u/2+w, .5)*np.heaviside(u/2-w, .5)+(np.heaviside(w-u/2, .5)+np.heaviside(-u/2-w, .5))*(u/2)**2/(w+np.specing(1)*abs(abs(np.sign(w))-1))**2)
...
def influence_LinLog(w,W,u):
    ...
    %   frequencies w and returns a same size array of the influence. 
    """
    return np.heaviside(u/2+w, .5)*np.heaviside(u/2-w, .5)+(np.heaviside(w-u/2, .5)+np.heaviside(-u/2-w, .5))*(u/2)/abs(w+np.specing(1)*abs(abs(np.sign(w))-1))
...
def influence_LinLog1D(w,W,u):
    ...
    %   frequencies w and returns a same size array of the influence. 
    """
    return np.sqrt(1-(2*w/W)**2)*np.heaviside(u/2+w, .5)*np.heaviside(u/2-w, .5)+(np.heaviside(w-u/2, .5)+np.heaviside(-u/2-w, .5))*(u/2)/abs(w+np.specing(1)*abs(abs(np.sign(w))-1))
