...
def CtmEnv_Hubbard(lattice, boundary, purification, xx, yy, D, sym, chi, interval, beta_end, beta_start, mu, t, step, tr_mode, fix_bd):
...
# to run, type in terminal : taskset -c 14-27 nohup python -u generate_CtmEnv_Hubbard.py -L 'rectangle' -x 5 -y 5 -B 'finite' -p 'False' -D 4 -S 'U1xU1_ind' -X 20 -I 2 -BETA_START 10.0 -BETA_END 20.0 -U 12 -M 0 -T 1 -STEP 'two-step' -MODE 'optimal' -FIXED 0 > env_spinfull_5_5_gs_U_12_D_4_MU_0_T_1.out &
