...
from yast.tn.peps.ctm import nn_avg, ctmrg, init_rand, one_site_avg, Local_CTM_Env, nn_bond
...
def not_test_NTU_spinfull_infinite():
    ...
    for step in ctmrg(tpeps, env, chi, cutoff, max_sweeps, iterator_step=1, AAb_mode=0, fix_signs=fix_signs):
