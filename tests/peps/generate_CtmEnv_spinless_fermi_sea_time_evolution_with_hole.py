...
def benchmark_EV_spinfull(lattice, boundary, purification, xx, yy, D, sym, chi, interval, beta_end, beta_start, mu, t, step, tr_mode, fix_bd):
...
if __name__== '__main__':
    ...
    parser.add_argument("-BETA_START", type=float, default=1.399) # location
    parser.add_argument("-BETA_END", type=float, default=3) # location
    parser.add_argument("-MU", type=float, default=0.)   # location                                                                                                 
    ...
    benchmark_EV_spinfull(lattice=args.L, boundary=args.B, xx=args.x, yy=args.y, D=args.D, sym=args.S,  chi=args.X, purification=args.p,
     interval=args.I, beta_start=args.BETA_START, beta_end=args.BETA_END, mu = args.MU, t = args.T, step=args.STEP, tr_mode=args.MODE, fix_bd=args.FIXED)
