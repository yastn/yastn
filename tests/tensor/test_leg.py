...
def test_get_structure(config_kwargs):
    ...
    tset, Dset, slices, size, nblocks, legs, charge = yastn.tensor._auxiliary.get_structure(config_U1.sym, (leg0, leg1, leg2), (0,), isdiag=False)
    print(tset)
    print(Dset)
    print(slices)
    print(size)
    ...
    tset, Dset, slices, size, nblocks, legs, charge = yastn.tensor._auxiliary.get_structure(config_U1.sym, (leg0, leg1, leg2), (0, 0), isdiag=False)
    print(tset)
    print(Dset)
    print(slices)
    print(size)
    ...
    tset, Dset, slices, size, nblocks, legs, charge = yastn.tensor._auxiliary.get_structure(config_U1.sym, (leg0, leg1, leg2), (), isdiag=False)
    print(tset.shape)
    print(Dset)
    print(slices)
    print(size)
