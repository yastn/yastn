...
def test_add0():
    ...
    b = tensor.rand(settings=settings_full_R, s=(-1, 1, 1, -1), D=(2, 3, 4, 5))
    ...
    d = tensor.rand(settings=settings_full_R, isdiag=True, D=5)
    d1 = d.copy()
    e1 = 2 * d1 - (d + d)
    e2 = 2 * d - d1 - d1
...
def test_add1():
    ...
    b = tensor.rand(settings=settings_U1_R, s=(-1, 1, 1, -1),
    ...
    d = tensor.eye(settings=settings_U1_R, isdiag=True, t=1, D=5)
    d1 = tensor.eye(settings=settings_U1_R, isdiag=True, t=2, D=5)
