...
def test_svd0():
    ...
    svd_and_combine(a)
    svd_order_and_combine(a)
    qr_and_combine(a)
    qr_order_and_combine(a)
    eigh_and_combine(a)
    eigh_order_and_combine(a)
