...
of :meth:`yastn.Tensor<yastn.Tensor>`'s which form the matrix product.
The symmetries of the tensors (which are contracted along the virtual dimension) have to be the same,
