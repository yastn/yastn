...
and on-site energy :math:`\mu`,
for different realizations of explicit symmetry: dense, Z2, or U1.

.. literalinclude:: /../../tests/mps/test_build_mpo_manually.py
...
Hamiltonian is generated by a function :code:`yastn.tn.mps.generate_mpo`
which takes an identity MPO and a Sequence[Hterm].

Spinless fermions with long-range hopping (Hterm)
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. literalinclude:: /../../tests/mps/test_generate_mpo.py
...
.. literalinclude:: /../../tests/mps/test_generator_class.py
