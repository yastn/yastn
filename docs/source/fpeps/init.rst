...
For purification, the state is an initialized as a maximally entangled state between the physical and auxilliary degrees of freedom using
.. autofunction:: yastn.tn.fpeps._initialization_peps.initialize_peps_purification

More details can be found here: 
:ref:`Purification<peps/purification:Purification>`

Examples are given in
:ref:`Purification<examples/peps/build:thermal expectation value of spinless fermi sea>`,
:ref:`Purification<examples/peps/build:thermal expectation value of spinful Hubbard model>`,
