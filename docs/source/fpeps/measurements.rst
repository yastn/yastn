...
one must initiate the CTMRG procedure using the function ctmrg with the peps tensors as the input,

.. autofunction:: yastn.tn.fpeps.ctm.ctmrg
...
observables which help us find the total energy.

Average of one-site observables for all sites can be calculated using the function 
